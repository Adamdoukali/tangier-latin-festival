...
ALTER TABLE public.bookings
  ...
  ADD COLUMN IF NOT EXISTS transfer_location text DEFAULT NULL,   -- e.g. 'Port of Tangier (Tanger Ville)', 'Tangier Ibn Battouta Airport (TNG)', 'Tetouan Sania Ramel Airport (TTU)'
...
COMMENT ON COLUMN public.bookings.transfer_location IS 'Specific port or airport name (Port of Tangier, Tangier Ibn Battouta Airport, Tetouan Airport)';
